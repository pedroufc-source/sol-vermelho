...
// Baseados em pesquisa sobre efeitos psicológicos da violência urbana
const PENSAMENTOS = [
    // Memórias do passado
    'A crise... as obras paradas...',
    'Minha mae nem sabe onde eu to.',
    'Eu era pedreiro. Construia coisa.',
    'Cicero disse que ia ser facil.',

    // Culpa e trauma
    'O sangue nao sai da mao.',
    'Amanha eu paro. Amanha.',
    'Nao consigo dormir.',
    '...',

    // Realidade das facções
    'Fronteira invisivel. Todo mundo sabe.',
    'Aqui nao tem gangue, tem faccao.',
    'Cada rua tem dono.',
    'Quem trai a Tropa, morre pela Tropa.',

    // Expulsão de moradores
    'Vi uma familia sair so com a roupa do corpo.',
    'Expulsaram a mulher. Parente de rival.',
    'O menino nao podia mais ir pra escola.',

    // Sistema de saúde precário
    'CAPS so atende dois por dia.',
    'Fila fechou. Volta amanha.',
    'Sistema caiu. Sempre cai.',
    ...
    'A DRACO ta de olho.',
    'O Batalhao RAIO... ironia do caralho.'
];
